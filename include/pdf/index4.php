...
if (isset($_POST['update'])) {
    ...
    $quoteSender = $_POST['quote_sender'];
    ...
    $sql = "INSERT into performa_logs (customer,job_description,size,quantity, date, ref,validity, total_price,price_vat,unit_price, types,requested_by,quote_sender) values 
                                    ('$customer','$job_desc','$size','$quantity','$date', '$ref', '$validity', '$ttnvt','$tot', '$unit_price','$types','$requestedBy','$quoteSender')";
    $result = mysqli_query($con, $sql);
...
?>
    ...
    <head>
        ...
        <!-- Site Title -->
        <title><?php echo $customer . '_' . $date; ?></title>
                    ...
                    <div class="tm_invoice_in">
                        <div class="tm_invoice_head tm_align_center tm_mb20">
                            ...
                            <div class="tm_invoice_right tm_text_right">
                                <div class="tm_primary_color tm_f40 tm_text_uppercase">Preforma Invoice</div>

                                <div class="tm_invoice_info tm_mb20">
                                    <div class="tm_invoice_seperator"></div>
                                    <div class="tm_invoice_info_list" style="margin-top: 50px;  ">
                                        <p class="tm_invoice_number tm_m0">VAT Registration No: <b class="tm_primary_color"><?= $vat_number ?></b></p>
                                        <p class="tm_invoice_date tm_m0">Tin No.: <b class="tm_primary_color"><?= $tin_number ?></b></p>
                        ...
                        <div class="tm_invoice_head tm_mb10">
                            <div class="tm_invoice_left">
                                <p class="tm_mb2"><b class="tm_primary_color">
                                        ...
                                        Invoice To: <?= $customer ?></b></p>
                                <p>
                                    Address: <b><?= $address ?></b><br>

                                    Requested By: <b><?= $requestedBy ?></b><br>
                            ...
                            <div class="tm_invoice_right tm_text_right">
                                ...
                                <p>
                                    ...
                                    Quote No.: <b><?= $ref ?></b><br>
                                    Quote Sender: <b><?= $quoteSender ?></b><br>
                    ...
                    <div class="tm_padd_15_20 tm_round_border">
                        ...
                        <ul class="tm_m0 tm_note_list">
                            <li>Prices are subject to change as additional information is supplied. Changes to
                                ...
                                <b>valid for <?= $validity ?> days</b> from the date indicated.
                            </li>
                            <li>100%[<b>Br <?= $tot ?></b>] will be invoiced at project delivery</li>
                        </ul>
                    </div><!-- .tm_note -->
                    <div style="margin-top: 10px; padding: 15px; " class="tm_round_border">
                        <p style="margin-bottom: 0">Thank you for opportunity to submit this estimate. We look forward to
                            working with you.</p>
                    </div>
                </div>
            </div>
