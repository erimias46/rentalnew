...
if (isset($_POST['generate_performa'])) {
    ...
    $sql = "INSERT INTO amh_email_log (`to`, `subject`, `email_body`, `from`, `to_city`, `to_comp_add`, `salut`, `ref`) 
                ...
                <div class="tm_invoice tm_style1" id="tm_download_section">
                    <div class="tm_invoice_in">
                        <div class="tm_invoice_head  tm_mb20">
                            ...
                            <div class="header"><img src="logo1.png" width="300px" height="100px" alt="Logo">
                                <div class="date">
                                    <div class="tm_invoice_info_list" style="margin-top: 90px;  ">

                                        <b class="tm_primary_color">ቀን :</b><b><?= $current_date ?></b>



                                        <b class="tm_primary_color">ማጣቀሻ ቁጥር :</b> <b>EDP/<?= $referenceNumber ?></b>
                        ...
                        <p class="tm_mb2"><b class="tm_primary_color"> ጉዳዩ : <?= $subject ?></b></p>
                        ...
                        <div class="tm_text_right" style="margin-top: 10px;  ">
                            <p style="margin-bottom: 0"> <?= $salut ?> <br /> <?= $from ?></p>
                        </div>
                    </div>
                </div>
