...
?>
                    ...
                    <div class="tm_invoice_in">
                        <div class="tm_invoice_head tm_align_center tm_mb20" style="margin-right: 60px;">
                            ...
                            <div class="tm_invoice_right tm_text_right">
                                <div class="tm_primary_color tm_f26 tm_text_uppercase">Remainder</div>
                                ...
                                <div class="tm_invoice_info tm_mb20">
                                    ...
                                    <div class="tm_invoice_info_list">
                                        ...
                                        <?php
                                        foreach ($_POST['update'] as $update_id) {
                                            $sql = "SELECT * FROM remainder WHERE generate_id = $update_id";
                                            $result = mysqli_query($con, $sql);
                                            $row = mysqli_fetch_assoc($result);
                                            if ($row == null)
                                                continue;
                    ...
                    EOF;
                        ...
                        <div class="tm_invoice_footer">
                            <div class="tm_left_footer">
                                <p class="tm_mb2">Amount in Words:<br><b class="tm_primary_color"><?= number_to_words($total_remainder) ?></b></p>
                            </div>
                            <div class="tm_right_footer">
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="tm_border_top tm_border_bottom">
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">Paid Amount
                                            </td>
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">
                                                <?= number_format(($tot - $total_remainder), 2) ?>
                                            </td>
                                        </tr>
                                        <tr class="tm_border_top tm_border_bottom">
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">Advance
                                            </td>
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">
                                        ...
                                        <tr class="tm_border_top tm_border_bottom">
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">Remaining Amount
                                            </td>
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">
                                                <?= number_format($total_remainder, 2) ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    <?php
    foreach ($_POST['update'] as $update_id) {
        $remove_verify = "DELETE FROM `remainder` WHERE generate_id = $update_id";
