                    ...
                    <div class="tm_invoice_in">
                        <div class="tm_invoice_head tm_align_center tm_mb20">
                            <div class="tm_invoice_left">
                                ...
                                <p class="tm_invoice_right tm_m">To: <b class="tm_primary_color"><?= $customer ?></b></p>
                            </div>
                            <div class="tm_invoice_right tm_text_right">
                                <div class="tm_primary_color tm_f50 tm_text_uppercase">Preforma Invoice</div>
                                ...
                                <div class="tm_invoice_info tm_mb20">
                                    ...
                                    <div class="tm_invoice_info_list" style="margin-top: 50px;  ">
                                        <p class="tm_invoice_number tm_m0">Date: <b class="tm_primary_color"><?= $current_date ?></b></p>
                    ...
                    <div class="tm_padd_15_20 tm_round_border">
                        ...
                        <ul class="tm_m0 tm_note_list">
                            <li>Prices are subject to change as additional information is supplied. Changes to
                                ...
                                <b>valid for 30 days</b> from the date indicated.
                            </li>
